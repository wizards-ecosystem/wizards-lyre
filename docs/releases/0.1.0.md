...
See the [0.1.0 changelog](https://github.com/wizards-ecosystem/wizards-lyre/blob/v0.1.0/CHANGELOG.md)
...
the [installation guide](https://github.com/wizards-ecosystem/wizards-lyre/blob/v0.1.0/docs/INSTALLATION.md).
For help, start with the
[troubleshooting guide](https://github.com/wizards-ecosystem/wizards-lyre/blob/v0.1.0/docs/TROUBLESHOOTING.md)
and [support policy](https://github.com/wizards-ecosystem/wizards-lyre/blob/v0.1.0/SUPPORT.md).
