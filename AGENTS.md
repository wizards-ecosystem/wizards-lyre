...
- Do not re-open product-scope research. If upstream ACE-Step parameter names change, adapt in the worker and keep Lyre's HTTP schema stable.
- Canonical clone is `/home/limb06/wizards-lyre` (WSL Ubuntu). Conclave's Windows `.projects/` jail does not apply here.
